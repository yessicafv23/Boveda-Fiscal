...
<div>
    <aside class="hidden sidebar bg-gray-50 xl:block  xl:fixed xl:border">
        ...
        <ul class="grid grid-cols-1 gap-y-16 text-center mt-10">
            <a class="py-2" href="/dashboard"><i class="fas fa-home text-xl text-gray-400"></i></a>
            <a class="py-2" href="/dashboard/factura"><i class="fas fa-plus text-xl text-gray-400 bg-gray-200 p-2 rounded"></i> </a>
            <a class="py-2" href="/dashboard/list"><i class="fas fa-table text-xl text-gray-400"></i></a>
        </ul>
    </aside>
    <aside class="navbar flex justify-between py-2 px-2 bg-gray-50 xl:absolute">
        ...
        <div class="group flex justify-center items-center">
            ...
            <p class="px-1 hidden xl:inline xl:text-xl">Bienvenido, Empresa</p>
        </div>
